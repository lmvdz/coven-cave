...
export const SUITES = {
  app: [
    ...
    "src/lib/canonical-response-buffer.test.ts",
    ...
    "src/lib/server/research-infographic-renderer.test.ts",
    ...
    "src/components/settings-fleet.test.ts",
    "src/lib/server/daemon-probe.test.ts",
    "src/lib/server/tailscale-devices.test.ts",
    "src/lib/server/fleet-control.test.ts",
    "src/lib/server/fleet-workspace.test.ts",
    ...
    "src/lib/response-status-tokens.test.ts",
    ...
    "src/lib/coven-promotion.test.ts",
    "src/lib/coven-run.test.ts",
    "src/lib/coven-run-signal.test.ts",
    "src/lib/coven-composer-routing.test.ts",
    "src/lib/coven-stop-scope.test.ts",
    "src/lib/coven-raw-output.test.ts",
    "src/lib/transcript-find.test.ts",
  ...
  api: [
    ...
    "src/app/api/research/generations/infographic/route.test.ts",
